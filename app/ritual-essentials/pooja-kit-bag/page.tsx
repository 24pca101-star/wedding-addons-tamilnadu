...
const CATEGORY = "ritual-essentials";
const SUBCATEGORY = "pooja-kit-bag";

export default function PoojaKitBagPage() {
      ...
      <div className="max-w-7xl mx-auto text-center">
        <header className="mb-12">
          ...
          <p className="text-gray-600 font-medium max-w-2xl mx-auto">
            Traditional and elegant bags for your pooja kits. Choose a design to start customizing.
          </p>
        </header>
